...
namespace MessageDbLib.DbRepository.ADO
{
    public class UserRepositoryMsSql : IUserRepository
    {
        ...
        public List<User> GetAllUsers()
        {
            ...
            {
                string message = string.Format("Error encountered when executing {0} function in UserRepositoryMsSql. Error\n{1}",
                    "Get-All-Entities", exception.Message);
        ...
        public User GetUserMatchingId(long id)
        {
            ...
            {
                string message = string.Format("Error encountered when executing {0} function in UserRepositoryMsSql. Error\n{1}",
                    "GetUserMatchingId", exception.Message);
                WriteErrorLog(message);
                throw;
            }
        }
        ...
        private Tuple<string, SqlParameter[]> GetUserMatchingUsernameQuery(string username)
        {
            ...
            string columns = GetSelectColumns();
            string query = string.Format("SELECT {0} FROM {1} WHERE USERNAME = {2}", columns,
                TableName,
        ...
        private Tuple<string, SqlParameter[]> GetUserInsertQuery(User user)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                new SqlParameter(UserParameter.USERNAME, DbValueUtil.GetValidValue(user.UserName)),
                new SqlParameter(UserParameter.PASSWORD, DbValueUtil.GetValidValue(user.Password)),
                new SqlParameter(UserParameter.EMAIL_ADDRESS, DbValueUtil.GetValidValue(user.EmailAddress)),
                new SqlParameter(UserParameter.FIRSTNAME, DbValueUtil.GetValidValue(user.FirstName)),
                new SqlParameter(UserParameter.SECONDNAME, DbValueUtil.GetValidValue(user.Surname)),
                new SqlParameter(UserParameter.DOB, DbValueUtil.GetValidValue(user.DOB)),
                new SqlParameter(UserParameter.GENDER, DbValueUtil.GetValidValue(user.Gender)),
                new SqlParameter(UserParameter.IS_ADVANCED_USER, DbValueUtil.GetValidValue(false))
            };
        ...
        private Tuple<string, SqlParameter[]> GetAdvancedUserInsertQuery(AdvancedUser user)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                ...
                new SqlParameter(UserParameter.DOB, DbValueUtil.GetValidValue(user.DOB)),
                new SqlParameter(UserParameter.GENDER, DbValueUtil.GetValidValue(user.Gender)),
                new SqlParameter(UserParameter.IS_ADVANCED_USER, DbValueUtil.GetValidValue(true)),
                new SqlParameter(UserParameter.ADVANCED_USER_START_DATE, DbValueUtil.GetValidValue(user.AdvanceStartDatetime)),
                new SqlParameter(UserParameter.ADVANCED_USER_END_DATE, DbValueUtil.GetValidValue(user.AdvanceEndDatetime))
            };
        ...
        private Tuple<string, SqlParameter[]> GetUpdateUserQuery(User user)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                new SqlParameter(UserParameter.ID, DbValueUtil.GetValidValue(user.Id)),
                new SqlParameter(UserParameter.PASSWORD, DbValueUtil.GetValidValue(user.Password)),
                new SqlParameter(UserParameter.FIRSTNAME, DbValueUtil.GetValidValue(user.FirstName)),
                new SqlParameter(UserParameter.SECONDNAME, DbValueUtil.GetValidValue(user.Surname)),
                new SqlParameter(UserParameter.DOB, DbValueUtil.GetValidValue(user.DOB)),
        ...
        private Tuple<string, SqlParameter[]> GetUpdateAdvancedUserQuery(AdvancedUser advancedUser)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                new SqlParameter(UserParameter.ID, DbValueUtil.GetValidValue(advancedUser.Id)),
                new SqlParameter(UserParameter.PASSWORD, DbValueUtil.GetValidValue(advancedUser.Password)),
                new SqlParameter(UserParameter.FIRSTNAME, DbValueUtil.GetValidValue(advancedUser.FirstName)),
                new SqlParameter(UserParameter.SECONDNAME, DbValueUtil.GetValidValue(advancedUser.Surname)),
                new SqlParameter(UserParameter.DOB, DbValueUtil.GetValidValue(advancedUser.DOB)),
                new SqlParameter(UserParameter.GENDER, DbValueUtil.GetValidValue(advancedUser.Gender)),
                new SqlParameter(UserParameter.EMAIL_ADDRESS, DbValueUtil.GetValidValue(advancedUser.EmailAddress)),
                new SqlParameter(UserParameter.ADVANCED_USER_START_DATE, DbValueUtil.GetValidValue(advancedUser.AdvanceStartDatetime)),
                new SqlParameter(UserParameter.ADVANCED_USER_END_DATE, DbValueUtil.GetValidValue(advancedUser.AdvanceEndDatetime))
            };
