...
namespace MessageDbLib.DbRepository.ADO
{
    public class MessageRepositoryMsSql : IMessageRepository
    {
        ...
        public Message GetMessageMatchingId(long messageId)
        {
            ...
            catch (Exception exception)
            {
                string message = string.Format("Error encountered when executing {0} function in MessageRepositoryMsSql. Error\n{1}",
                    "GetMessageMatchingId", exception.Message);
        ...
        public List<Message> GetAllMessages()
        {
            ...
            {
                string message = string.Format("Error encountered when executing {0} function in MessageRepositoryMsSql. Error\n{1}",
                    "GetAllMessage", exception.Message);
                WriteErrorLog(message);
                throw;
            }
        }
        ...
        private Tuple<string, SqlParameter[]> GetMessageMatchingTextQuery(string text)
        {
            ...
            string columns = GetSelectColumns();
            string query = string.Format("SELECT {0} FROM {1} WHERE MESSAGETEXT = {2}",
                columns,
                TableName,
        ...
        private Tuple<string, SqlParameter[]> GetTextInsertQuery(Message message)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                new SqlParameter(MessageParameter.MESSAGE_TEXT, message.MessageText),
                new SqlParameter(MessageParameter.SENDER_ID, message.SenderId),
                new SqlParameter(MessageParameter.SENDER_EMAIL_ADDRESS, message.SenderEmailAddress),
                new SqlParameter(MessageParameter.MESSAGE_CREATED, message.MessageCreated),
                new SqlParameter(MessageParameter.MULTI_MEDIA_TYPE, MessageTypeConstant.Text)
            };

            string insertColumns = string.Format(@"INSERT INTO {0}({1}, {2}, {3}, {4}, {5})",
                TableName,
            ...
            string valueSection = string.Format(@"VALUES ({0}, {1}, {2}, {3}, {4})",
                MessageParameter.MESSAGE_TEXT,
        ...
        private Tuple<string, SqlParameter[]> GetPictureInsertQuery(PictureMessage pictureMessage)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                new SqlParameter(MessageParameter.MESSAGE_TEXT, pictureMessage.MessageText),
                new SqlParameter(MessageParameter.SENDER_ID, pictureMessage.SenderId),
                new SqlParameter(MessageParameter.SENDER_EMAIL_ADDRESS, pictureMessage.SenderEmailAddress),
                new SqlParameter(MessageParameter.MESSAGE_CREATED, pictureMessage.MessageCreated),
                new SqlParameter(MessageParameter.MULTI_MEDIA_TYPE, MessageTypeConstant.Picture),
                new SqlParameter(MessageParameter.UNIQUE_QUID, pictureMessage.UniqueGuid),
                new SqlParameter(MessageParameter.FILE_NAME, pictureMessage.FileName),
                new SqlParameter(MessageParameter.MEDIA_FILE_TYPE, pictureMessage.MediaFileType),
                new SqlParameter(MessageParameter.FILE_SIZE, pictureMessage.FileSize),
                new SqlParameter(MessageParameter.IMAGE_TYPE, pictureMessage.ImageType)
            };
        ...
        private Tuple<string, SqlParameter[]> GetVideoInsertQuery(VideoMessage videoMessage)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                new SqlParameter(MessageParameter.MESSAGE_TEXT, videoMessage.MessageText),
                new SqlParameter(MessageParameter.SENDER_ID, videoMessage.SenderId),
                new SqlParameter(MessageParameter.SENDER_EMAIL_ADDRESS, videoMessage.SenderEmailAddress),
                new SqlParameter(MessageParameter.MESSAGE_CREATED, videoMessage.MessageCreated),
                new SqlParameter(MessageParameter.MULTI_MEDIA_TYPE, MessageTypeConstant.Video),
                new SqlParameter(MessageParameter.UNIQUE_QUID, videoMessage.UniqueGuid),
                new SqlParameter(MessageParameter.FILE_NAME, videoMessage.FileName),
                new SqlParameter(MessageParameter.MEDIA_FILE_TYPE, videoMessage.MediaFileType),
                new SqlParameter(MessageParameter.FILE_SIZE, videoMessage.FileSize),
                new SqlParameter(MessageParameter.LENGTH, videoMessage.Length)
            };
        ...
        private Tuple<string, SqlParameter[]> GetDefaultTextUpdateQuery(Message message)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                ...
                new SqlParameter(MessageParameter.SENDER_EMAIL_ADDRESS, message.SenderEmailAddress),
                new SqlParameter(MessageParameter.MESSAGE_CREATED, message.MessageCreated),
                new SqlParameter(MessageParameter.ID, message.Id)
            };
        ...
        private Tuple<string, SqlParameter[]> GetDefaultPictureUpdateQuery(PictureMessage pictureMessage)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                ...
                new SqlParameter(MessageParameter.FILE_SIZE, pictureMessage.FileSize),
                new SqlParameter(MessageParameter.IMAGE_TYPE, pictureMessage.ImageType),
                new SqlParameter(MessageParameter.ID, pictureMessage.Id)
            };
        ...
        private Tuple<string, SqlParameter[]> GetDefaultVideoUpdateQuery(VideoMessage videoMessage)
        {
            SqlParameter[] sqlParameters = new SqlParameter[]
            {
                ...
                new SqlParameter(MessageParameter.FILE_SIZE, videoMessage.FileSize),
                new SqlParameter(MessageParameter.LENGTH, videoMessage.Length),
                new SqlParameter(MessageParameter.ID, videoMessage.Id)
            };
        ...
        public void DeleteMessage(Message message)
        {
            ...
            {
                string eMessage = string.Format("Error encountered when executing {0} function in MessageRepositoryMsSql. Error\n{1}",
                    "DeleteMessage", exception.Message);
                WriteErrorLog(eMessage);
                throw;
            }
        }
